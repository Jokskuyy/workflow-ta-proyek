...
def test_c2_synthetic_zero_match_is_detected(base_entries, tmp_path):
    ...
    write_all(entries, out)
    detail = f"entry diagram_tahap_pengembangan caption_match '{target}' now resolves to 0 captions"
...
def test_c2_synthetic_multi_match_is_detected(base_entries, tmp_path):
    ...
    write_all(entries, out)
    detail = f"entry diagram_tahap_pengembangan caption_match '{target}' now resolves to 2 captions"
