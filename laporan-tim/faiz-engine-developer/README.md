...
2. **Rendering Rute Visual** — subdivisi linear titik `NavMeshPath`, raycast vertikal, dan moving average; label nama tujuan & jarak.
...
- Fungsi helper Catmull-Rom masih terdapat pada script historis, tetapi tidak dipanggil oleh alur rendering final dan tidak boleh diklaim sebagai implementasi aktif.
