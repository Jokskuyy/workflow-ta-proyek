...
- [ ] 1. Tangkap Output_Baseline dan oracle preservasi (jaring pengaman, WAJIB pertama)
  - [ ] 1.1 Tangkap Output_Baseline dari Draf saat ini ke `tests/fixtures/`
  ...
  - [ ] 1.2 Bekukan salinan oracle fungsi lama untuk perbandingan byte-per-byte
...
- [ ] 2. Tokenizer inline tangguh (R2)
  - [ ] 2.1 Implementasi `tokenize_inline` murni dan model token
  ...
  - [ ]* 2.5 Uji properti preservasi tokenizer terhadap oracle baseline
  ...
  - [ ] 2.6 Integrasi wrapper `add_formatted_text` dan rels hyperlink di `merge_draft_to_xml`
...
- [ ] 4. Daftar Pustaka dinamis bersumber Draf (R1)
  - [ ] 4.1 Implementasi parser entri referensi murni
...
- [ ] 5. Penjenjangan daftar oleh indentasi (R3)
  - [ ] 5.1 Implementasi `compute_list_level` dan integrasi ke `parse_markdown`
  ...
  - [ ]* 5.2 Uji properti level daftar monoton dan invarian terhadap penanda
    - **Feature: writing-pipeline-improvements, Property 9: Level daftar monoton dan invarian terhadap penanda**
    - **Validates: Requirements 3.1, 3.2, 3.3, 3.5**
    - Hypothesis ≥100 iterasi

  - [ ]* 5.3 Uji unit kompatibilitas mundur level daftar
...
- [ ] 7. Tabel pipa standar + perataan kolom, opt-in (R5)
  - [ ] 7.1 Implementasi parser Tabel_Pipa murni
  ...
  - [ ] 7.2 Perluas `build_table_element` untuk perataan kolom
  ...
  - [ ]* 7.3 Uji properti struktur dan perataan Tabel_Pipa
    - **Feature: writing-pipeline-improvements, Property 10: Struktur dan perataan Tabel_Pipa**
    - **Validates: Requirements 5.1, 5.2, 5.3**
    - Hypothesis ≥100 iterasi

  - [ ]* 7.4 Uji properti ekuivalensi Tabel_Kurung terhadap oracle baseline
  ...
  - [ ] 7.5 Integrasi `detect_pipe_table` ke `parse_markdown` (Opt_In_By_Content)
...
- [ ] 8. Penjaga penulisan non-fatal pada validator (R6 + cross-check R1)
  - [ ] 8.1 Implementasi kolektor guard murni di Mesin_Merge
  ...
  - [ ]* 8.9 Uji unit mode fatal cross-check
...
- [ ] 10. Penomoran daftar terurut Word, opsional (R4)
  - [ ] 10.1 Tambah cabang `numPr` opt-in di `build_p_element`
  ...
  - [ ]* 10.2 Uji unit jalur numPr opt-in
    - Uji R4.1 (numPr aktif), R4.2/R4.3 (nonaktif → identik baseline)
    - _Requirements: 4.1, 4.2, 4.3_

- [ ] 11. Build end-to-end + verifikasi kompatibilitas mundur
  - [ ]* 11.1 Uji properti preservasi lintas-area Opt_In_By_Content (tingkat dokumen)
  ...
  - [ ]* 11.2 Uji integrasi build Draf saat ini → nol fatal
