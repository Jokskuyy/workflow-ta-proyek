...
- [ ] 1. Tangkap baseline & siapkan guard kompatibilitas mundur
  - [ ] 1.1 Buat skrip penangkap baseline Dokumen_Referensi
...
- [ ] 2. Helper deteksi bab & registri penomoran kapsi (Mesin_Format)
  - [ ] 2.1 Implementasi `parse_chapter_number`
  ...
  - [ ]* 2.2 Tulis property test untuk penetapan Nomor_Bab dari BAB pembungkus
  ...
  - [ ] 2.3 Implementasi `CaptionRegistry`
  ...
  - [ ]* 2.4 Tulis property test penomoran per-bab berurutan
  ...
  - [ ]* 2.5 Tulis property test opsi restart SEQ pada kapsi pertama bab
  ...
  - [ ]* 2.6 Tulis property test fallback Nomor_Bab tanpa berhenti
...
- [ ] 3. Helper deskripsi kapsi dari draf & Aturan_Umum gambar tanpa kapsi (Mesin_Format)
  - [ ] 3.1 Implementasi ekstraksi Deskripsi_Kapsi verbatim + aturan gambar tanpa kapsi
  ...
  - [ ]* 3.2 Tulis property test deskripsi kapsi verbatim
  ...
  - [ ]* 3.3 Tulis property test gambar tanpa kapsi tidak diberi kapsi/nomor
  ...
  - [ ]* 3.4 Tulis property test tidak ada teks kapsi non-draf
...
- [ ] 4. Helper deteksi seksi & heading dinamis (Mesin_Format)
  - [ ] 4.1 Implementasi `find_front_matter_boundary` dan `find_heading`
  ...
  - [ ]* 4.2 Tulis property test deteksi heading/seksi invarian
  ...
  - [ ]* 4.3 Tulis property test fallback deteksi seksi terstruktur
...
- [ ] 5. Helper reference rewriter dari registri (Mesin_Format)
  - [ ] 5.1 Implementasi derivasi remap + `rewrite_references`
  ...
  - [ ]* 5.2 Tulis property test renumbering konsisten dengan kapsi
  ...
  - [ ]* 5.3 Tulis property test referensi tak berpadanan dipertahankan
  ...
  - [ ]* 5.4 Tulis property test referensi ambigu dipertahankan
...
- [ ] 6. Checkpoint - Pastikan helper Mesin_Format lulus uji
  - Pastikan semua test lulus, tanyakan ke pengguna bila ada pertanyaan.

- [ ] 7. Integrasikan tiga fase ke `format_document_xmls`
  - [ ] 7.1 Fase 0 — deteksi struktur dinamis
  ...
  - [ ] 7.2 Fase 1 — chapter-aware caption pass tunggal
  ...
  - [ ] 7.3 Fase 2 — terapkan reference rewriter
  ...
  - [ ]* 7.4 Tulis unit/integration test untuk `format_document_xmls`
...
- [ ] 8. Helper pencocokan asosiasi Gambar_Template (Mesin_Merge)
  - [ ] 8.1 Implementasi `normalize_assoc_text`, `is_caption_text`, `find_template_matches`
  ...
  - [ ]* 8.2 Tulis property test invarian pencocokan asosiasi
  ...
  - [ ]* 8.3 Tulis property test pencocokan hanya antar sejenis
  ...
  - [ ]* 8.4 Tulis property test tie-break kecocokan ganda
...
- [ ] 9. Konfigurasi path Mesin_Merge tanpa nilai absolut
  - [ ] 9.1 Implementasi `resolve_path` + pembacaan konfigurasi + `main(argv)`
  ...
  - [ ]* 9.2 Tulis property test resolusi path
  ...
  - [ ]* 9.3 Tulis unit test prioritas & guard path
...
- [ ] 10. Integrasikan kebijakan pencocokan ke `merge_draft_to_xml`
  - [ ] 10.1 Terapkan Aturan_Umum + tie-break + logging pada alur merge
  ...
  - [ ]* 10.2 Tulis integration test asosiasi merge
    - Uji `merge_draft_to_xml` atas XML sintetis: unmatched dicatat & lanjut, kecocokan ganda → pertama,
      tanpa kasus khusus bernama
    - _Requirements: 4.3, 4.4_

- [ ] 11. Sinkronkan salinan scratch/skills
  - [ ] 11.1 Sinkronkan skrip yang diubah ke salinan yang dijalankan pipeline
...
- [ ] 12. Verifikasi kompatibilitas mundur & integrasi penuh
  - [ ]* 12.1 Tulis property test nomor kapsi identik dengan Dokumen_Referensi
  ...
  - [ ]* 12.2 Tulis integration test pipeline end-to-end + validator
  ...
  - [ ] 12.4 Implementasi kontrol promosi & peringatan beda nomor
...
- [ ] 13. Checkpoint akhir - Build penuh + pytest
