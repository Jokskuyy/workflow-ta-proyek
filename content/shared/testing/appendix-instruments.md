Instrumen UAT menggunakan skala Likert 1 sampai 5. Kode responden pada lampiran ini dianonimkan dan tidak dipetakan kepada nama peserta. Redaksi pernyataan disalin dari instrumen kerja dengan normalisasi ejaan tanpa mengubah makna pertanyaan. Hasil agregat dan batas interpretasinya tetap dibahas pada Subbab 3.5 agar lampiran ini berfungsi sebagai bukti instrumen, bukan analisis kedua.

Instrumen pengguna publik yang diperlihatkan pada [TABREF:lampiran_instrumen_uat_publik] terdiri atas sembilan pernyataan mengenai kegunaan, kemudahan, desain, dan kinerja sistem.

[TABLE-ID:lampiran_instrumen_uat_publik]
[TABLECAPTION:Instrumen UAT Pengguna Publik]
...
Rekap anonim pada [TABREF:lampiran_rekap_responden_uat] menunjukkan kelengkapan instrumen dan jumlah skor per responden. Tanda em dash berarti peserta tidak mengisi instrumen tersebut; kondisi ini menjelaskan mengapa terdapat lima peserta unik, tetapi masing-masing instrumen memperoleh empat respons.

[TABLE-ID:lampiran_rekap_responden_uat]
[TABLECAPTION:Rekap Anonim Respons UAT]

[TABLE]
Kode Responden | Skor Pengguna Publik | Skor Dashboard Admin | Kelengkapan
...
R-04 | 31 dari 45 | — | Mengisi instrumen pengguna publik
...
Hasil awal 24 skenario Black Box berada pada `Hasil UAT/Hasil_BlackBox.docx`. Retest BB-20 didukung oleh dua frame berurutan `BB20_1.png` dan `BB20_2.png` yang menunjukkan kondisi sebelum dan sesudah penyelesaian navigasi.
