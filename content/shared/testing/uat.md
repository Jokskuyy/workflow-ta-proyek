User Acceptance Testing merupakan pengujian yang melibatkan pengguna untuk menilai apakah fungsi dan pengalaman penggunaan sistem telah memenuhi kebutuhan operasional pengguna akhir (Aliyah et al. 2025). UAT pada sistem integrasi denah virtual menggunakan skala Likert 1 sampai 5, dengan nilai 1 menunjukkan penilaian sangat kurang dan nilai 5 menunjukkan penilaian sangat baik.

Peserta dipilih secara purposif berdasarkan keterlibatan dan kompetensinya dalam mengevaluasi proyek. Lima peserta unik terdiri atas dua dosen penguji, dua dosen pembimbing, dan satu perwakilan Humas UPNVJ. Hasil pengujian menggambarkan penilaian kelima peserta tersebut dan tidak dimaksudkan untuk digeneralisasi sebagai pendapat seluruh sivitas akademika UPNVJ.

Pengujian menggunakan dua instrumen. Instrumen pengguna publik terdiri atas sembilan pernyataan dan diisi oleh empat peserta, sedangkan instrumen dashboard admin terdiri atas sebelas pernyataan dan diisi oleh empat peserta. Terdapat lima peserta unik karena sebagian peserta mengevaluasi kedua instrumen. Pengolahan angka menggunakan data rekapitulasi pada `Hasil_UAT.xlsx`, sementara formulir PDF digunakan untuk memeriksa jawaban dan masukan terbuka.
