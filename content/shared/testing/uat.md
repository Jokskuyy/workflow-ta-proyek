...
Pengujian menggunakan dua instrumen berdasarkan komponen aplikasi yang dinilai. Instrumen evaluasi Dashboard Publik terdiri atas sembilan pernyataan dan diisi oleh empat peserta, sedangkan instrumen evaluasi Panel Admin terdiri atas sebelas pernyataan dan diisi oleh empat peserta. Istilah Dashboard Publik menunjukkan bagian aplikasi yang dinilai, bukan kategori asal peserta. Terdapat lima peserta unik karena sebagian peserta mengevaluasi kedua instrumen. Pengolahan angka menggunakan data rekapitulasi pada `Hasil_UAT.xlsx`, sementara formulir PDF digunakan untuk memeriksa jawaban dan masukan terbuka.
...
Hasil pengolahan instrumen evaluasi Dashboard Publik dirangkum pada [TABREF:uat_dashboard_publik].
...
Hasil pengolahan instrumen Panel Admin dirangkum pada [TABREF:uat_dashboard_admin].

[TABLE-ID:uat_dashboard_admin]
[TABLECAPTION:Rekapitulasi UAT Panel Admin]
...
Jika kedua instrumen digabungkan berdasarkan seluruh jawaban yang tersedia, total skor mencapai 326 dari skor maksimum 400 atau 81,50 persen. Tidak terdapat jawaban bernilai 1 atau 2 pada rekapitulasi. Hasil kuantitatif ini menunjukkan kecenderungan penilaian positif pada sesi tertutup, tetapi tidak dapat digunakan sebagai bukti penerimaan pengguna publik dan tidak menghilangkan kebutuhan untuk menindaklanjuti masukan kualitatif peserta.
